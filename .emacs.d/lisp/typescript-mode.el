;; Made the following changes (Nick Matyas, Oct 25, 2017)
;;  - Replaced "cl-" methods with the non "cl-" versions
;;    i.e. "cl-return-from" -> "return-from"
;;  - changed indent from 4 to 2
;;    (defcustom typescript-indent-level 2
